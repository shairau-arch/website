...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/jdmt.css')); ?>">
</head>
<body>
  ...
  <header class="header">
    <div class="container nav">
      <a href="#home" class="logo">
        <img src="<?php echo e(asset('assets/img/jdmt-logo.png')); ?>" alt="JDMT Logo" style="height:50px;">
      </a>
  ...
  <div class="header-marquee">
    <div class="header-marquee-track">
      <img src="<?php echo e(asset('assets/img/krispy kreme.png')); ?>" alt="Client">
      <img src="<?php echo e(asset('assets/img/client2.png')); ?>" alt="Client">
      <img src="<?php echo e(asset('assets/img/client1.png')); ?>" alt="Client">
      <img src="<?php echo e(asset('assets/img/client3.png')); ?>" alt="Client">
      <img src="<?php echo e(asset('assets/img/client4.jpg')); ?>" alt="Client">
      <img src="<?php echo e(asset('assets/img/client5.png')); ?>" alt="Client">
      <img src="<?php echo e(asset('assets/img/client6.png')); ?>" alt="Client">
      <img src="<?php echo e(asset('assets/img/client7.png')); ?>" alt="Client">
      <img src="<?php echo e(asset('assets/img/client8.jpg')); ?>" alt="Client">
      <img src="<?php echo e(asset('assets/img/client9.jpg')); ?>" alt="Client">
  ...
  <section class="section-space bg-soft" id="partners">
    <div class="container">
      ...
      <div class="partners-grid reveal">
        <img src="<?php echo e(asset('assets/img/b1.png')); ?>" alt="Partner 1">
        <img src="<?php echo e(asset('assets/img/b2.png')); ?>" alt="Partner 2">
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="product-grid">
        ...
        <div class="product-gallery reveal">
          <img src="<?php echo e(asset('assets/img/p1.png')); ?>" alt="Product 1">
          <img src="<?php echo e(asset('assets/img/p2.png')); ?>" alt="Product 2">
          <img src="<?php echo e(asset('assets/img/p3.png')); ?>" alt="Product 3">
          <img src="<?php echo e(asset('assets/img/p4.png')); ?>" alt="Product 4">
          <img src="<?php echo e(asset('assets/img/p5.png')); ?>" alt="Product 5">
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="team-slider-shell reveal">
        <div class="team-wrap" id="teamScroll">
          <article class="team-card">
            ...
            <div class="team-avatar-wrap">
              <div class="team-avatar-ring">
                <img src="<?php echo e(asset('assets/img/hesus.png')); ?>" alt="Team member">
              </div>
            </div>
            <div class="team-body">
              <h3>Full Name</h3>
          ...
          <article class="team-card">
            ...
            <div class="team-avatar-wrap">
              <div class="team-avatar-ring">
                <img src="<?php echo e(asset('assets/img/jake.png')); ?>" alt="Team member">
              </div>
            </div>
            <div class="team-body">
              <h3>Full Name</h3>
          ...
          <article class="team-card">
            ...
            <div class="team-avatar-wrap">
              <div class="team-avatar-ring">
                <img src="<?php echo e(asset('assets/img/jr.png')); ?>" alt="Team member">
              </div>
            </div>
            <div class="team-body">
              <h3>Full Name</h3>
          ...
          <article class="team-card">
            ...
            <div class="team-avatar-wrap">
              <div class="team-avatar-ring">
                <img src="<?php echo e(asset('assets/img/rona.png')); ?>" alt="Team member">
              </div>
            </div>
            <div class="team-body">
              <h3>Full Name</h3>
  ...
  <section class="section-space bg-soft" id="clients">
    <div class="container">
      ...
      <div class="clients-grid reveal">
        <div class="client-logo-card"><img src="<?php echo e(asset('assets/img/krispy kreme.png')); ?>" alt="Client"></div>
        <div class="client-logo-card"><img src="<?php echo e(asset('assets/img/client2.png')); ?>" alt="Client"></div>
        <div class="client-logo-card"><img src="<?php echo e(asset('assets/img/client1.png')); ?>" alt="Client"></div>
        <div class="client-logo-card"><img src="<?php echo e(asset('assets/img/client3.png')); ?>" alt="Client"></div>
        <div class="client-logo-card"><img src="<?php echo e(asset('assets/img/client4.jpg')); ?>" alt="Client"></div>
        <div class="client-logo-card"><img src="<?php echo e(asset('assets/img/client5.png')); ?>" alt="Client"></div>
        <div class="client-logo-card"><img src="<?php echo e(asset('assets/img/client6.png')); ?>" alt="Client"></div>
        <div class="client-logo-card"><img src="<?php echo e(asset('assets/img/client7.png')); ?>" alt="Client"></div>
        <div class="client-logo-card"><img src="<?php echo e(asset('assets/img/client8.jpg')); ?>" alt="Client"></div>
        <div class="client-logo-card"><img src="<?php echo e(asset('assets/img/client9.jpg')); ?>" alt="Client"></div>
      </div>
    </div>
  </section>
...
<?php /**PATH D:\xampp\htdocs\jdmt_site\resources\views/jdmt.blade.php ENDPATH**/ ?>